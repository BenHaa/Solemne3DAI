                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <form method="POST" action="../server/BuscarPorRut.php">
                                <table border="1" id="BuscarPorRut">
                                    <thead>
                                        <tr>
                                            <th colspan="2"> Buscar por Rut</th>
                                        </tr>
                                ...
                                <input type="submit" value="Buscar" name="btnBuscarPorRut" id="btnBuscarPorRut"/>
                            </form>    


                            <form method="POST" action="../server/BuscarPorFecha.php">
                                <table border="1" id="buscarPorFecha">
                                    <thead>
                                        <tr>
                                            <th colspan="2"> Buscar por Rut</th>
                                        </tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>&nbsp; Desde &nbsp;   <input type="date" name="clnDesde"></td>
                                            <td>&nbsp; Hasta &nbsp; <input type="date" name="clnHasta" value="" /></td>

                                        </tr>
                                    </tbody>

                                </table>
                                <input type="submit" value="Buscar" id="btnBuscarPorFecha" name="btnBuscarPorFecha" />
                            </form>    
